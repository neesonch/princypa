...
- As per one of the suggested additional features from the [guidelines](https://github.com/ethyca/typescript-takehome), a full system description for each system can be viewed by clicking on the card header to expand it
